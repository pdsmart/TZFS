...
## Credits:         
## Copyright:       (c) 20218-2023  Philip Smart <philip.smart@net2net.org>
##
...
CPM_PATH=${ROOTDIR}/CPM
ROMDIR=${ROOTDIR}/roms                     # Compiled or source ROM files.
MZFDIR=${ROOTDIR}/MZF/Common               # MZF Format source files.
HDRDIR=${ROOTDIR}/hdr                      # MZF Header directory for building images.
DISKSDIR=${ROOTDIR}/disks                  # MZF Binary sectored output files to go into ROMS.
